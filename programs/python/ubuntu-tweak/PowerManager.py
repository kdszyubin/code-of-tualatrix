...
class PowerManager(gtk.VBox):
		...
		box = TablePack(_("<b>Advanced Power Management Settings</b>"), [
			...
			[Factory.create("gconfcheckbutton", _("Show CPU frequency option in \"Power Management\""), "cpufreq_show")],
			[Factory.create("gconfcheckbutton", _("Disconnected NetworkManager on sleep"), "network_sleep")],
